...
class Juego extends StatefulWidget {
  ...
  const Juego({Key? key, this.usuario, required this.email, required this.usuarioId}) : super(key: key);
...
void startTimer(BuildContext context) {
  ...
  Widget build(BuildContext context) {
    ...
    var axisNumber = 4;
    var fontFamily = 'Silk'; 
    var textStyle = TextStyle(fontFamily: fontFamily, color: Colors.white, fontSize: 18.0);
        ...
        body: Column(
          children: [
            Row(
              ...
              children: [
                board('Tiempo' , '$startTime', TextStyle(fontFamily: fontFamily, color: Colors.white, fontSize: 18.0)),
                          ...
                          setState(() {
                            ...
                            if (_game.matchCheck.length == 2) {
                              if (_game.matchCheck[0].values.first ==
                                ...
                                if(score==800){
                                  timer.cancel();
                                  _showDialog(context, '¡Ganaste!','Tu puntuación fue: $score');
                                }
                                print('true');
                              } else {
                                print('false');
          ...
          TextButton(
            ...
            onPressed: () async {
              ...
              if (widget.email != null) {
                final nuevoPuntaje = {"fecha": getCurrentDate(), "puntuacion": score};
